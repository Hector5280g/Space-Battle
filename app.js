function Submit () {
    alert(
      "Welcome! - open the console log on the page to play . The Aliens are coming HURRY! You have been drafted to fight for us! Don't let them win our kid's lives depend on it! "
    );
  }
...
let enemies = [];
enemies.unshift((Alien7 = new Alien("AL #7")));
enemies.unshift((Alien6 = new Alien("AL #6")));
enemies.unshift((Alien5 = new Alien("AL #5")));
enemies.unshift((Alien4 = new Alien("AL #4")));
enemies.unshift((Alien3 = new Alien("AL #3")));
enemies.unshift((Alien2 = new Alien("AL #2")));
enemies.unshift((Alien1 = new Alien("AL #1")));
...
console.log("%cBeep Beep Beep Boop 'warning aliens detected ' Beep Beep Beep Boop","background: lightyellow; color:red; font-size:12px;");
